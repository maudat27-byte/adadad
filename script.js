...
const WISH_MESSAGES = [
	...
	"Năm mới bình an",
	"Chúc mọi điều ước của anh em đều trở thành hiện thực ✨",
	"Chúc gia đình anh em luôn bình an và hạnh phúc ❤️",
	"Chúc các bạn luôn khỏe mạnh và tràn đầy năng lượng 💪",
	"Chúc công việc,học tập thuận lợi, thăng tiến không ngừng 🚀",
